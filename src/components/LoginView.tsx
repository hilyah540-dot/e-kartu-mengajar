      ...
      <div className="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-8 md:p-10 text-center relative overflow-hidden">
        ...
        {lastUsername && !showManualLogin ? (
          <div className="animate-fade-in space-y-4">
            <div className="bg-white border-0 shadow-[0_4px_20px_rgb(0,0,0,0.06)] p-5 rounded-2xl cursor-pointer hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:-translate-y-0.5 transition-all duration-300 text-left flex items-center gap-4 group"
